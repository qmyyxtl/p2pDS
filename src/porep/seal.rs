...
use fr32::Fr32Ary;
use storage_proofs::{merkle::BinaryMerkleTree, util::NODE_SIZE};
...
pub fn generate_piece_commitment_bytes_from_source<H: 'static + Hasher>(
    source: &mut dyn Read,
...
pub fn seal_pre_commit_phase1_inner<Tree: 'static + MerkleTreeTrait>(
    registered_proof: RegisteredSealProof,
    cache_path: &Path,
    in_path: &Path,
    out_path: &Path,
